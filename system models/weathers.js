...
WeatherSystemMorph.prototype.createCorral = function() {
	...
	this.corral.addSoil = function(soil) {
		this.contents.add( new WeatherIconMorph(soil) );
		this.fixLayout();
	};
...
// This funciton creates the soil editor window morph.
WeatherSystemMorph.prototype.createWeatherEditor = function() {
	...
	if(this.currentTab === 'scripts') {
		...
		// finish the soil editor parameters
...
SoilIconMorph.prototype.init = function (aWeather, aTemplate) {
